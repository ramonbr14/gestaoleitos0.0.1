...
CREATE TABLE IF NOT EXISTS `mydb`.`paciente` (
  ...
  `paccpf` VARCHAR(11) NULL,
  `pacnome` VARCHAR(100) NOT NULL COMMENT '\n',
  `pacsexo` VARCHAR(20) NULL,
  `paccns` VARCHAR(15) NULL,
  `pacletcodigo` INT NULL,
  `pacprncodigo` INT NULL,
  PRIMARY KEY (`paccodigo`),
  INDEX `fk_paciente_leito1_idx` (`pacletcodigo` ASC) VISIBLE,
  INDEX `fk_paciente_paciente1_idx` (`pacprncodigo` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_paciente_paciente1`
    FOREIGN KEY (`pacprncodigo`)
    REFERENCES `mydb`.`paciente` (`paccodigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`paciente_has_leito`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`paciente_has_leito` ;

CREATE TABLE IF NOT EXISTS `mydb`.`paciente_has_leito` (
  `paciente_paccodigo` INT NOT NULL,
  `leito_letcodigo` INT NOT NULL,
  `pachletdataent` VARCHAR(45) NOT NULL,
  `pachletdatasaida` VARCHAR(45) NULL,
  `pachletmotivo` VARCHAR(45) NULL,
  PRIMARY KEY (`paciente_paccodigo`, `leito_letcodigo`, `pachletdataent`),
  INDEX `fk_paciente_has_leito_leito1_idx` (`leito_letcodigo` ASC) VISIBLE,
  INDEX `fk_paciente_has_leito_paciente1_idx` (`paciente_paccodigo` ASC) VISIBLE,
  CONSTRAINT `fk_paciente_has_leito_paciente1`
    FOREIGN KEY (`paciente_paccodigo`)
    REFERENCES `mydb`.`paciente` (`paccodigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_paciente_has_leito_leito1`
    FOREIGN KEY (`leito_letcodigo`)
    REFERENCES `mydb`.`leito` (`letcodigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
